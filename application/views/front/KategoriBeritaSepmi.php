			...
			<div class="col-lg-8">
				<div class="container" style="height:900px; width:100%;">
					<div class="container-post"
						style="padding: 0.5rem 0.5rem; width:100%; height: 100%; overflow:auto;">
						<?php foreach ($sepmi as $b): ?>
							<div class="row blog-entry blog-entry-search-item mb-3">
								<div class="col-md-5">
									<a href="single.html" class="img-link me-4">
										<img src="<?php echo base_url() . '/assets/photo/' . $b->gambar ?>" alt="Image"
											class="img-fluid" width="260px">
									</a>
								</div>
								<div class="col-md-7">
									<span class="date">
										<?= $b->tanggal; ?> &bullet; <a href="#">
											<?= $b->kategori; ?>
										</a>
									</span>
									<h4><a href="<?= base_url(); ?>C_home/DetailBerita/<?= $b->id_berita; ?>">
											<?= $b->judul; ?>
										</a></h4>
									<!-- <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Unde, nobis ea quis inventore vel voluptas.</p> -->
									<p><a href="<?= base_url(); ?>C_home/DetailBerita/<?= $b->id_berita; ?>"
										...
										<li>
											<a href="<?= base_url(); ?>C_home/DetailBerita/<?= $b['id_berita']; ?>">
												<img src="<?php echo base_url() . '/assets/photo/' . $b['gambar'] ?>"
													alt="Image placeholder" class="me-4 rounded" width="50px;">
